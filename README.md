...
>
> This package remains useful for **multiple shortcuts per element** and **shortcuts on any widget** (text inputs, sliders, etc.) - features not yet in native Streamlit ([#1291](https://github.com/streamlit/streamlit/issues/1291), [PR #12975](https://github.com/streamlit/streamlit/pull/12975)).
